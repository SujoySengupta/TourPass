"""
Django settings for TourPass project.
...
SECRET_KEY = 'django-insecure-=-1f@fu3p)3il9h$nh1zr43c+br7!(anclcl6tntf9b3hnv+4e'
...
WSGI_APPLICATION = 'TourPass.wsgi.application'
